  ...
  return (
    <NavigationMenuPortal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          // z-50 matters: this is portaled to <body>, a sibling of #root, and
          // #root carries z-index 1 so the app paints above the fixed
          // background texture layers. Without a higher z-index here the popup
          // renders *behind* the page and every click lands on the page instead.
